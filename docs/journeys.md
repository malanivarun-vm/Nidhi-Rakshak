...
| 13 | Member-ID self-service | UNCONFIRMED / BLOCKING: whether Jan-2025 self-service reaches past member-ID records. Settle by portal login, not search (PRD §44 item 4). Hero case (J1 Forward branch) preserved until confirmed. | 2026-08-27 |
...
| 15 | Taxonomy code count | v2 coverage summary states 37 total; the enumerated A-F tables list 38 distinct codes. Source off-by-one, preserved verbatim, flagged for reconciliation. | 2026-08-27 |
